...
class ParametersControllerTest < ActionController::TestCase
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post :create, parameter: { description: @parameter.description, name: @parameter.name, type: @parameter.type, value: @parameter.value }
    end
  ...
  test "should update parameter" do
    put :update, id: @parameter, parameter: { description: @parameter.description, name: @parameter.name, type: @parameter.type, value: @parameter.value }
    assert_redirected_to parameter_path(assigns(:parameter))
  end
